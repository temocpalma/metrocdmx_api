...
RSpec.describe SubwayEngine::Lines::LinesByStationFinder, type: :model do
  describe 'call' do
    before(:all) do
      @subway_data = [
        {
    ...
    context 'when station target is C12' do
      ...
      let(:result) { SubwayEngine::Lines::LinesByStationFinder.call(@subway_data, station_target) }
      it 'returns 1 y 2' do
